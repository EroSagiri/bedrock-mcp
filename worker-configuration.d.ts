/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4c401be27dffb315ac5cfdc0605609f9)
// Runtime types generated with workerd@1.20260426.1 2026-04-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/mcp/src/entrypoint");
		durableNamespaces: "MineralMCP" | "VaultIndex";
	}
	interface Env {
		MINERAL: R2Bucket;
		MCP_OBJECT: DurableObjectNamespace<import("./apps/mcp/src/entrypoint").MineralMCP>;
		VAULT_INDEX: DurableObjectNamespace<import("./apps/mcp/src/entrypoint").VaultIndex>;
	}
}
