/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 21ef8cd4d0f8121e494435887213af33)
// Runtime types generated with workerd@1.20260426.1 2026-04-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BedrockMCP" | "VaultIndex";
	}
	interface Env {
		BEDROCK: R2Bucket;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").BedrockMCP>;
		VAULT_INDEX: DurableObjectNamespace<import("./src/index").VaultIndex>;
	}
}
