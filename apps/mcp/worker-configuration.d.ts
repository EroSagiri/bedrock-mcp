/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/mcp/wrangler.jsonc apps/mcp/worker-configuration.d.ts` (hash: 25865ae51d22f6e4f50fb8b002b3ade9)
...
interface __BaseEnv_Env {
	...
	VAULT_INDEX: DurableObjectNamespace /* VaultIndex from mineral-vault */;
	VAULT: Fetcher /* mineral-vault */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entrypoint");
		durableNamespaces: "MineralMCP";
	}
