/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/mcp/wrangler.jsonc apps/mcp/worker-configuration.d.ts` (hash: 5f267a682b12138b04516371620dae41)
// Runtime types generated with workerd@1.20260918.1 2026-04-28 nodejs_compat
interface __BaseEnv_Env {
	MINERAL: R2Bucket;
	MCP_OBJECT: DurableObjectNamespace<import("./src/entrypoint").MineralMCP>;
	VAULT_INDEX: DurableObjectNamespace<import("./src/entrypoint").VaultIndex>;
	VAULT: Fetcher /* mineral-vault */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entrypoint");
		durableNamespaces: "MineralMCP" | "VaultIndex";
	}
