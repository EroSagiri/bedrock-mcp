/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/mcp/wrangler.jsonc apps/mcp/worker-configuration.d.ts` (hash: cd95e37567d42bffe9a9e7d12f1dbc0b)
