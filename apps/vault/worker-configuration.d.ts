/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/vault/wrangler.jsonc apps/vault/worker-configuration.d.ts` (hash: 9bde97cf3a9b28ce26ef9a6598472a13)
