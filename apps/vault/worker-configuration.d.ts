/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/vault/wrangler.jsonc apps/vault/worker-configuration.d.ts` (hash: 3e678d9c87fe490a9893a41c8276d7c0)
// Runtime types generated with workerd@1.20260918.1 2026-04-28 nodejs_compat
interface __BaseEnv_Env {
	MINERAL: R2Bucket;
	VECTORIZE: VectorizeIndex;
	AI: Ai;
	INDEXING_ENABLED: "true";
	MINERAL_R2_ENDPOINT: "https://68b8b99e8abecd71aa2412b31c52b2b5.r2.cloudflarestorage.com";
	MINERAL_BUCKET: "mineral";
	MINERAL_REMOTE_PREFIX: "";
	VAULT_INDEX: DurableObjectNamespace<import("./src/entrypoint").VaultIndex>;
	SYNC_GATEWAY: Service /* entrypoint SyncGatewayEntrypoint from mineral-sync-gateway */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entrypoint");
		durableNamespaces: "VaultIndex";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INDEXING_ENABLED" | "MINERAL_R2_ENDPOINT" | "MINERAL_BUCKET" | "MINERAL_REMOTE_PREFIX">> {}
}
