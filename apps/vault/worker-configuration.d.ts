/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/vault/wrangler.jsonc apps/vault/worker-configuration.d.ts` (hash: 16b7cb1b3b398b19bdf1328b4ca2559c)
