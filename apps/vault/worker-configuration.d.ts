/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/vault/wrangler.jsonc apps/vault/worker-configuration.d.ts` (hash: e09a6555b291a349f0fc13877c6547af)
// Runtime types generated with workerd@1.20260918.1 2026-04-28 nodejs_compat
interface __BaseEnv_Env {
	MINERAL: R2Bucket;
	VAULT_INDEX: DurableObjectNamespace /* VaultIndex from mineral-mcp */;
}
