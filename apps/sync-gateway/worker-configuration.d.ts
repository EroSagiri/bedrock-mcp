/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/sync-gateway/wrangler.jsonc apps/sync-gateway/worker-configuration.d.ts` (hash: 3c3236561e065f776f2ab487ff324e77)
// Runtime types generated with workerd@1.20260918.1 2026-04-28 nodejs_compat
interface __BaseEnv_Env {
	REMOTE_CHANGE_HUB: DurableObjectNamespace<import("./src/index").RemoteChangeHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RemoteChangeHub";
	}
